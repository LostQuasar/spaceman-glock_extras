...
class GLOCK_ZAPPER_BARREL {
    static onLoadMod() {        
        ...
        SpaceApi.AddItemSlotFilter("5a7ae0c351dfba0017554310", itemId, SpaceApi.FindSlotIndex("5a7ae0c351dfba0017554310", "mod_barrel"));
        SpaceApi.AddItemSlotFilter("GLOCK_21", itemId, SpaceApi.FindSlotIndex("GLOCK_21", "mod_barrel"));
        SpaceApi.AddItemSlotFilter("GLOCK_ZAPPER", itemId, SpaceApi.FindSlotIndex("GLOCK_ZAPPER", "mod_barrel"));
